...
interface TaskDao {
    ...
    @Query("SELECT * FROM tasks WHERE syncStatus = :status AND isTemplate = 0")
    ...
    @Query("SELECT * FROM tasks WHERE syncStatus = 'CONFLICT' AND isTemplate = 0")
    ...
    @Query("SELECT COUNT(*) FROM tasks WHERE syncStatus = 'PENDING' AND isTemplate = 0")
    suspend fun getPendingSyncCount(): Int

    @Query("SELECT COUNT(*) FROM tasks WHERE syncStatus = 'CONFLICT' AND isTemplate = 0")
