...
private val DarkColorScheme = darkColorScheme(
    primary = Color(0xFF4FC3F7), secondary = Color(0xFF29B6F6), tertiary = Color(0xFF66BB6A),
...
private val LightColorScheme = lightColorScheme(
    primary = Color(0xFF4FC3F7), secondary = Color(0xFF29B6F6), tertiary = Color(0xFF4CAF50),
    background = Color(0xFFF5F7FA), surface = Color.White,
    onPrimary = Color.White, onSecondary = Color.White, onTertiary = Color.White,
    onBackground = Color(0xFF2C3E50), onSurface = Color(0xFF2C3E50),
    error = Color(0xFFF44336), onError = Color.White
)
...
val AccentPurple: Color @Composable @ReadOnlyComposable get() = LocalAppColors.current.accentPurple
val BgPrimary: Color @Composable @ReadOnlyComposable get() = LocalAppColors.current.bgPrimary
val BgCard: Color @Composable @ReadOnlyComposable get() = LocalAppColors.current.bgCard
val BgSecondary: Color @Composable @ReadOnlyComposable get() = LocalAppColors.current.bgSecondary
